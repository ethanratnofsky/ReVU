...
const Button = ({ fontSize=18, imgSrc, onPress, style, text='Button' }) => {
    return (
        <TouchableOpacity onPress={onPress} style={{...buttonStyles.outterContainer, ...style}}>
            <LinearGradient 
                ...
                <View style={buttonStyles.innerContainer}>
                    { imgSrc && 
                        <Image style={{ ...buttonStyles.icon, width: fontSize, height: fontSize + 4 }} source={imgSrc} />
                    }
