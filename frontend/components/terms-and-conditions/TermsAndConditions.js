...
const TermsAndConditions = ({ navigation, route }) => {
    ...
    return (
        <SafeAreaView style={termsAndConditionsStyles.container}>
            <Image style={termsAndConditionsStyles.logo} source={require('../../assets/images/revu-logo.png')} />
            ...
            { firstTime &&
                <Pressable style={termsAndConditionsStyles.acceptInputContainer} onPress={() => setIsAccepted(prev => !prev)}>
                    <Checkbox
                    ...
                    />
                    <Text style={termsAndConditionsStyles.agreeText}>I have read and agree to ReVU's terms and conditions.</Text>
                </Pressable>
            }
            <Button 
